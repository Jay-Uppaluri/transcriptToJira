  ...
  return (
    <div className="min-h-screen bg-white text-[#37352f] font-sans selection:bg-[rgba(45,170,219,0.3)] overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-[#e9e8e4]">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <button onClick={() => navigate('/')} className="flex items-center gap-2 font-medium text-xl tracking-tight">
            <Bot className="w-6 h-6 text-[#37352f]" />
            <span>AgentSync</span>
          </button>
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => navigate('/app')} className="bg-[#37352f] hover:bg-[#2f2d28] text-white text-sm font-medium px-5 py-2 rounded-[3px]">
              Get Started
            </button>
          </div>
        </div>
      ...
      <section className="pt-40 pb-0 px-6 relative overflow-hidden">
        {/* Concentric Circles — 2 large rings with orbiting images */}
        <div
        ...
        >
          ...
          >
            {/* Outer ring orbiting images — radius = 600 */}
            <OrbitingImage src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop" alt="Asset 4" size={52} radius={600} startAngle={30} duration={120} reverse />
            <OrbitingImage src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop" alt="Asset 5" size={46} radius={600} startAngle={120} duration={120} reverse />
            <OrbitingImage src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop" alt="Asset 6" size={50} radius={600} startAngle={210} duration={120} reverse />
            <OrbitingImage src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop" alt="Asset 7" size={44} radius={600} startAngle={300} duration={120} reverse />
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center relative" style={{ zIndex: 3 }}>
          ...
          <FadeInSection delay="300ms" className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button onClick={() => navigate('/app')} className="w-full sm:w-auto bg-[#37352f] hover:bg-[#2f2d28] text-white font-medium px-8 py-3.5 rounded-[3px] flex items-center justify-center gap-2">
              Start Free Trial
              <ChevronRight className="w-4 h-4" />
            </button>
            <button className="w-full sm:w-auto bg-[#f7f6f3] hover:bg-[#eeedea] text-[#37352f] font-medium px-8 py-3.5 rounded-[3px] flex items-center justify-center gap-2">
        ...
        <FadeInSection delay="500ms" className="max-w-5xl mx-auto mt-20 pb-20 relative group cursor-pointer">
          <div className="relative aspect-video bg-[#f7f6f3] rounded-[6px] border border-[#e9e8e4] overflow-hidden flex items-center justify-center">
            ...
            <div className="absolute inset-0 bg-white flex flex-col">
              <div className="h-12 border-b border-[#e9e8e4] flex items-center px-4 gap-2">
                ...
                <div className="mx-auto w-64 h-6 bg-[#f7f6f3] rounded-[3px] border border-[#e9e8e4]"></div>
              </div>
              <div className="flex-1 bg-[#f7f6f3]/50 p-8 flex items-center justify-center">
                 <div className="w-full h-full max-w-3xl border border-[#e9e8e4] rounded-[3px] bg-white flex flex-col">
                   {/* Fake editor lines */}
                   <div className="p-6 space-y-4">
                      <div className="w-1/3 h-6 bg-[#f7f6f3] rounded-[3px]"></div>
                      <div className="w-full h-4 bg-[#f7f6f3]/60 rounded-[3px] mt-4"></div>
                      <div className="w-5/6 h-4 bg-[#f7f6f3]/60 rounded-[3px]"></div>
                      <div className="w-4/6 h-4 bg-[#f7f6f3]/60 rounded-[3px]"></div>
                   </div>
                 </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            <FadeInSection delay="300ms" className="relative z-10 flex flex-col items-center text-center">
              <div className="w-24 h-24 bg-[#37352f] rounded-[6px] flex items-center justify-center mb-6 group hover:-translate-y-2 transition-transform duration-300">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <FadeInSection>
              ...
              <p className="text-lg text-[#787774] mb-8 leading-relaxed">
                Forget manually copying text from a Word document to a Jira ticket. AgentSync establishes a bi-directional living link between your product requirements and developer tasks.
              </p>
            ...
            <FadeInSection delay="200ms" className="relative">
              <div className="absolute inset-0 bg-[#f7f6f3] transform -skew-y-3 rounded-[6px] -z-10"></div>
              <div className="p-8">
                {/* Abstract Sync Visualization */}
                <div className="bg-white rounded-[6px] border border-[#e9e8e4] p-6 flex flex-col gap-6">

                  {/* PRD Mockup */}
                  <div className="flex items-center justify-between p-4 rounded-[3px] bg-[#f7f6f3] border border-[#e9e8e4]">
                    <div className="flex items-center gap-4">
                  ...
                  <div className="flex justify-center py-2 relative">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 bg-[#f7f6f3] rounded-full flex items-center justify-center z-10">
      ...
      {/* Bottom CTA */}
      <section className="py-24 relative overflow-hidden bg-[#37352f] text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <FadeInSection>
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
              Ready to ship faster?
            </h2>
            <p className="text-xl text-[#9b9a97] mb-10 max-w-2xl mx-auto">
              Join the innovative product teams who have automated their workflow from meetings to deployment.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button onClick={() => navigate('/app')} className="w-full sm:w-auto bg-white hover:bg-[#f7f6f3] text-[#37352f] font-medium px-8 py-4 rounded-[3px] flex items-center justify-center gap-2 text-lg">
                Get Started for Free
                <ArrowRight className="w-5 h-5" />
              </button>
            </div>
            <p className="mt-6 text-sm text-[#787774]">No credit card required. 14-day free trial.</p>
          </FadeInSection>
        </div>
      </section>
      ...
      <footer className="bg-white border-t border-[#e9e8e4] py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-sm text-[#9b9a97]">
            &copy; {new Date().getFullYear()} AgentSync Inc. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
